...
if __name__ == "__main__":
    ...
    checkpoing_dir = path.expanduser('/opt/data/private/Project/ImageSegmentation/PIPO-FAN/data/preCT_256/lits17/5_fold_cv/fold' + cv + '/tmp/concave')
    if not path.isdir(checkpoing_dir):
        os.makedirs(checkpoing_dir)
        
    log_dir = path.expanduser('/opt/data/private/Project/ImageSegmentation/PIPO-FAN/data/preCT_256/lits17/5_fold_cv/fold' + cv + '/tmp/concave')
    if not path.isdir(log_dir):
        os.makedirs(log_dir)
    """
    training
    ...
    folder_training = '/opt/data/private/Project/ImageSegmentation/PIPO-FAN/data/preCT_256/lits17/5_fold_cv/fold' + cv + '/training/'
    folder_validation = '/opt/data/private/Project/ImageSegmentation/PIPO-FAN/data/preCT_256/lits17/5_fold_cv/fold' + cv + '/validation/'
